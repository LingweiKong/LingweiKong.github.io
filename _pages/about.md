...
12\. [Publicly Verifiable Private Information Retrieval Protocols Based on Function Secret Sharing](https://scholar.google.com/citations?user=2nM_30EAAAAJ&hl=zh-CN), Lin Zhu, **Lingwei Kong**, Xin Ning, Xiaoyang Qu, Jianzong Wang. **Inscrypt 2025**. (CCF-C) (Co-first Author)
...
7\. [A Competition of Shape and Texture Bias by Multi-view Image Representation](https://scholar.google.com/citations?user=2nM_30EAAAAJ&hl=zh-CN), **Lingwei Kong**, Jianzong Wang, Zhangcheng Huang, Jing Xiao. **PRCV 2021**. (First Author)
...
5\. [Modeling Without Sharing Privacy: Federated Neural Machine Translation](https://scholar.google.com/citations?user=2nM_30EAAAAJ&hl=zh-CN), Jianzong Wang, Zhangcheng Huang, **Lingwei Kong**, Denghao Li, Jing Xiao. **WISE 2021**. (CCF-B) (Corresponding Author)

4\. [Network Coding for Federated Learning Systems](https://scholar.google.com/citations?user=2nM_30EAAAAJ&hl=zh-CN), **Lingwei Kong**, Hengtao Tao, Jianzong Wang, Zhangcheng Huang, Jing Xiao. **ICONIP 2020**. (CCF-C) (First Author)
...
5\. [Survey on Time-Lock Puzzles](https://au.cnki.net/author/personalInfo/000066981556?platform=kns-author) [J], Lin Zhu, **Lingwei Kong**, Jianhan Wu, et al. **Chinese Journal of Network and Information Security (CCF-T1), 2026**.

4\. [A Survey on the Fairness of Federated Learning](https://au.cnki.net/author/personalInfo/000066981556?platform=kns-author) [J], Zhitao Zhu, Shijing Si, Jianzong Wang, Ning Cheng, **Lingwei Kong**, Zhangcheng Huang, Jing Xiao. **Big Data Research (CCF-T2), 2024**.

3\. [Survey on Graph Neural Networks](https://au.cnki.net/author/personalInfo/000066981556?platform=kns-author) [J], Jianzong Wang, **Lingwei Kong**, Zhangcheng Huang, et al. **Computer Engineering (CCF-T2, Peking University Core), 2021**. (Corresponding Author)

2\. [Research Advances on Privacy Protection of Federated Learning](https://au.cnki.net/author/personalInfo/000066981556?platform=kns-author) [J], Jianzong Wang, **Lingwei Kong**, Zhangcheng Huang, et al. **Big Data Research (CCF-T2), 2021**. (Corresponding Author)
...
11\. **Outstanding Instructor** of the "New FinTech" Teachers' Day Commendation of Ping An Technology, 2025 **(Company Level)**

10\. **Top Ten Teams** of Ping An Technology, 2023 **(Company Level)**

9\. **Top Ten Outstanding Projects** of Ping An Group, 2023 **(Group Technology Development Committee)**

8\. The 1st AIGC Innovation Competition of Ping An Group, **Third Prize**, Lead Presenter, 2023 **(Group Technology Development Committee)**

7\. The 7th Group CTF Competition, Team Leader, **Finalist**, 2023 **(Group Information Security Department)**

6\. **Top Ten Outstanding Teams in Business Contribution** of Ping An Group, 2022 **(Group Technology Development Committee)**

5\. The 6th Group CTF Competition, Team Leader, **Finalist**, 2022 **(Group Information Security Department)**

4\. **Major Project Award** of Ping An Technology, 2020 **(Company Level)**

3\. The 4th Group CTF Competition, **Second Prize**, 2020 **(Group Information Security Department)**

2\. The 5th Group Micro-innovation Competition, **First Prize & Best Popularity Award**, 2019 **(Group Technology Development Committee)**
...
4\. **No.2024YFB4504300** National Key R&D Program, Young Scientists Project (**Key Member**)

3\. **No.2018YFB1003500** National Key R&D Program, "Cloud Computing and Big Data Project" (**Key Member**)

2\. **No.2018YFB0204403** National Key R&D Program, "High Performance Computing Project" (**Member**)
...
3\. **No.ZDCY20250901100302003** Shenzhen Key Industry R&D Program - Embodied Intelligence Edge-side Robots (**Key Member**)

2\. **No.SGDX20240115103359001** Shenzhen-Hong Kong Joint Funding Project, Category A - Federated Large Models (**Key Member**)
...
5\. [*Privacy-Preserving Computing Interconnection Technology and Scenario Practice in the Financial Industry*](https://www.bfia.org.cn/sites/home/MsgView.jsp?msgId=29562), Beijing FinTech Industry Alliance, 2025 (White Paper)
